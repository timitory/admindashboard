  ...
  <div class="mt-8">
    <div class="mt-8 px-6 pt-6 relative shadow-lg bg-white lg:relative lg:pb-8">
        <div class="lg:flex lg:justify-between">
            <p class="font-bold">Manage cancel requests for health cover</p>
            <div class="lg:flex lg:gap-4"> 
              <download-excel :data="policiess" :name="fileName" class="right">
                ...
                <div class="its-center flex text-sm mt-4 relative border border-solid">
...
import DeclineModal from "@/components/Home/DeclineModal"
export default {
  components:{
  ...
  data(){
    return {
      ...
      showDecline : false,
      request : {},
      fileName: 'health_cancel_request',
      policiess: [],
    }
  },
  computed:{
  ...
  methods: {
    ...
    getRequests(){
      this.$store.commit('startLoading')
      axios.get(`${baseURL}/admin/cancellation?type=health`)
      .then((res)=> {
        this.$store.commit('endLoading')
