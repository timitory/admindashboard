  ...
  <div class="mt-8">
    <div class="mt-8 px-6 pt-6 relative shadow-lg bg-white lg:relative lg:pb-8">
        <div class="lg:flex lg:justify-between">
            <p class="mt-2 mb-4 font-bold text-lg">This contains information of every user on the home content cover policy</p>
            <div class="lg:flex lg:gap-4"> 
                ...
                <!-- <div class="items-center flex text-sm mt-4 relative border border-solid">
                    ...
                    <div v-if="showFilter" class="filter shadow-lg absolute left-0 bg-white">
                        <p class="mb-2 cursor-pointer text-sm" @click="filter('start')">Status</p>
                        <p class="mb-2 cursor-pointer text-sm" @click="filter('end')">Plan</p>
                    </div>
                </div> -->
            </div>
        </div>      
