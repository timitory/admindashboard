...
export default {
  ...
  methods: {
    ...
    axios.get(`${baseURL}/admin/homecontent/users/search?search=${this.searchKeyword}`)
    .then(res =>{
    ...
    changePage(num){
      console.log(num)
      this.$store.commit('startLoading')
      axios.get(`${baseURL}/admin/homecontent/users`, {params :{page : num}})
      .then(res=>{
        console.log(res.data.data)
        this.totalRows = res.data.data.totalRecord
        this.policies = res.data.data.records
  ...
  mounted(){
    this.$store.commit('startLoading')
    axios.get(`${baseURL}/admin/homecontent/users`)
    .then(res =>{
      console.log(res.data.data)
      this.totalRows = res.data.data.totalRecord
      this.policies = res.data.data.records
