  ...
  <div class="mt-8">
    <div class="mt-8 px-6 pt-6 relative shadow-lg bg-white lg:relative lg:pb-8">
        <div class="lg:flex lg:justify-between">
            <p class="mt-2 mb-4 font-bold text-lg">This is the Repayment activities associated with home content Cover</p>
...
export default {
  ...
  methods: {
    ...
    changePage(num){
      ...
      axios.get(`${baseURL}/admin/homecontent/repayments`, {params :{page : num}})
      .then(res=>{
    ...
    viewHistory(obj){
      ...
      this.$router.push('/app/dashboard/homecontent/repayment/chargehistory')
    }
  },
  mounted(){
    this.$store.commit('startLoading')
    axios.get(`${baseURL}/admin/homecontent/repayments`)
    .then(res =>{
      console.log(res.data.data)
      this.totalRows = res.data.data.totalRecord
      this.policies = res.data.data.records
