            ...
            <div class="pt-6 relative">
                <div class="py-4">
                     ...
                     <div class="grid gap-4">
                        <label for="text" class="">Input the Customers name: </label>
                     ...
                     <div class="mt-8 md:flex md:w-3/4 md:mx-auto md:items-center gap-6">
                         <button @click="yes" v-if="this.remittance.customer.firstname+' '+this.remittance.customer.lastname == this.namecheck" class="focus:outline-none block w-full rounded border border-solid border-green-500 text-green-500 text-white md:px-3 py-2">Yes, Proceed</button>
