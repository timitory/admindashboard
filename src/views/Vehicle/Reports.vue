    ...
    <div class="mt-8">
        <div class="bg-white rounded px-8 py-8 lg:py-12 relative" style="border: 0.20000000298023224px solid #707070;">
            ...
            <div class="flex gap-4 item-end">
                <svg fill="#0c4a4d" xmlns="http://www.w3.org/2000/svg" width="39.5" height="39.5" viewBox="0 0 39.5 39.5">
                    <path class="a"
        ...
        <div class=" mt-8 px-6 pt-6 relative shadow-lg bg-white lg:relative lg:pb-8">
            ...
            <div>
                <Table v-if="tab === 'vehiclereport'" :policies="policies" :totalRecords="totalRecords" v-on:changePage="changePage" />
                <Table1 v-else-if="tab === 'claimtable'" class="importclaim"  />
            </div>
        </div>
...
import Table1 from "@/components/Vehicle/ClaimsTable"
import { mapState } from 'vuex'
import axios from "axios"
import baseURL from "@/main"
export default {
    components: {
        Stats, DoughnutChart, LineChart, Table, Table1,
    },
    data() {
        return {
            year: '',
